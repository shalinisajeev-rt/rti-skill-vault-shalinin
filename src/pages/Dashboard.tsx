...
import { Users, FolderOpen, Brain, TrendingUp } from "lucide-react";
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          Welcome to RTI-Skill Matrix Tracker 3. Here's an overview of your organization.
        </p>
      </div>
          ...
          <CardContent>
            <div className="space-y-4">
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="flex-1">
                  <p className="text-sm font-medium">React skill added to matrix</p>
